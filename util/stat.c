...
# include <fs_info.h>
#endif
//XXX HKY #include <selinux/selinux.h>

//XXX HKY #include "system.h"

//XXX HKY #include "error.h"
//XXX HKY #include "filemode.h"
//XXX HKY #include "file-type.h"
//XXX HKY #include "fs.h"
#include "getopt.h"
//XXX HKY #include "quote.h"
//XXX HKY #include "quotearg.h"
//XXX HKY #include "stat-time.h"
//XXX HKY #include "strftime.h"
//XXX HKY #include "areadlink.h"
...
// XXX HKY  {GETOPT_HELP_OPTION_DECL},
// XXX HKY  {GETOPT_VERSION_OPTION_DECL},
  {NULL, 0, NULL, 0}
};

/* Whether to follow symbolic links;  True for --dereference (-L).  */
static bool_t follow_links;

/* Whether to interpret backslash-escape sequences.
   True for --printf=FMT, not for --format=FMT (-c).  */
static bool_t interpret_backslash_escapes;
...
static bool_t
do_statfs (char const *filename, bool_t terse, char const *format)
{
...
static bool_t
do_stat (char const *filename, bool_t terse, char const *format)
{
  struct stat statbuf;
